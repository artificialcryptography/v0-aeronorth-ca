    ...
    <div className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute h-full w-full">
          <Image
            src="/images/multispectral.jpg"
            alt="Multispectral aerial imagery"
            fill
        ...
        <div id="projects" className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <Button
              ...
              className={`${filter === "all" ? "bg-white/20" : "bg-transparent"} text-white border-white hover:bg-white/20`}
            >
              All Projects
            </Button>
            <Button
              ...
              className={`${filter === "construction" ? "bg-white/20" : "bg-transparent"} text-white border-white hover:bg-white/20`}
            >
              Construction
            </Button>
            <Button
              ...
              className={`${filter === "environmental" ? "bg-white/20" : "bg-transparent"} text-white border-white hover:bg-white/20`}
            >
              Environmental
            </Button>
            <Button
              ...
              className={`${filter === "mining" ? "bg-white/20" : "bg-transparent"} text-white border-white hover:bg-white/20`}
            >
              Mining
            </Button>
            <Button
              ...
              className={`${filter === "inspection" ? "bg-white/20" : "bg-transparent"} text-white border-white hover:bg-white/20`}
            >
              Inspection
            </Button>
          </div>
            ...
            {filteredProjects.map((project) => (
              <Dialog key={project.id}>
                <DialogTrigger asChild>
                  <Card className="bg-white/10 backdrop-blur-sm overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300 border border-white/20">
